...
def chi_sqr(stack_vel_obs, stack_vel_model, stack_flux_obs, stack_flux_model, err):
    ...
    stack_vel_obs, stack_flux_obs, err = snip(stack_vel_obs, stack_flux_obs, err, 0, 13)
    stack_vel_model, stack_flux_model = snip_simp(stack_vel_model, stack_flux_model, 0, 13)
    chisqr = 0
...
plt.plot(stack_vel_sun2_mod2, stack_flux_sun2_mod2 - (np.max(stack_flux_sun2_mod2) - 1), linestyle='--', label = "1/3x Solar $^{13}$CO")
plt.plot(stack_vel_sun2_mod3, stack_flux_sun2_mod3 - (np.max(stack_flux_sun2_mod3) - 1), linestyle='--', label = "Solar $^{13}$CO")
plt.plot(stack_vel_sun2_mod4, stack_flux_sun2_mod4 - (np.max(stack_flux_sun2_mod4) - 1), linestyle='--', label = "3x Solar $^{13}$CO")
plt.xlabel("Velocity (km/s)")
plt.ylabel("Normalized Flux Intensity")
plt.axvline(x = 0, color= 'k', linestyle='--')
plt.legend()
...
plt.plot(stack_vel_sun3_mod2, stack_flux_sun3_mod2 - (np.max(stack_flux_sun3_mod2) - 1), linestyle='--', label = "1/3x Solar $^{13}$CO")
plt.plot(stack_vel_sun3_mod3, stack_flux_sun3_mod3 - (np.max(stack_flux_sun3_mod3) - 1), linestyle='--', label = "Solar $^{13}$CO")
plt.plot(stack_vel_sun3_mod4, stack_flux_sun3_mod4 - (np.max(stack_flux_sun3_mod4) - 1), linestyle='--', label = "3x Solar $^{13}$CO")
plt.xlabel("Velocity (km/s)")
plt.xlabel("Velocity (km/s)")
plt.ylabel("Normalized Flux Intensity")
plt.axvline(x = 0, color= 'k', linestyle='--')
...
plt.plot(stack_vel_sun4_mod2, stack_flux_sun4_mod2 - (np.max(stack_flux_sun4_mod2) - 1), linestyle='--', label = "1/3x Solar $^{13}$CO")
plt.plot(stack_vel_sun4_mod3, stack_flux_sun4_mod3 - (np.max(stack_flux_sun4_mod3) - 1), linestyle='--', label = "Solar $^{13}$CO")
plt.plot(stack_vel_sun4_mod4, stack_flux_sun4_mod4 - (np.max(stack_flux_sun4_mod4) - 1), linestyle='--', label = "3x Solar $^{13}$CO")
plt.xlabel("Velocity (km/s)")
plt.ylabel("Normalized Flux Intensity")
plt.axvline(x = 0, color= 'k', linestyle='--')
plt.legend()
...
plt.plot(stack_vel_sun5_mod2, stack_flux_sun5_mod2 - (np.max(stack_flux_sun5_mod2) - 1), linestyle='--', label = "1/3x Solar $^{13}$CO")
plt.plot(stack_vel_sun5_mod3, stack_flux_sun5_mod3 - (np.max(stack_flux_sun5_mod3) - 1), linestyle='--', label = "Solar $^{13}$CO")
plt.plot(stack_vel_sun5_mod4, stack_flux_sun5_mod4 - (np.max(stack_flux_sun5_mod4) - 1), linestyle='--', label = "3x Solar $^{13}$CO")
plt.xlabel("Velocity (km/s)")
plt.ylabel("Normalized Flux Intensity")
plt.axvline(x = 0, color= 'k', linestyle='--')
plt.legend()
...
plt.plot(stack_vel_sun6_mod2, stack_flux_sun6_mod2 - (np.max(stack_flux_sun6_mod2) - 1), linestyle='--', label = "1/3x Solar $^{13}$CO")
plt.plot(stack_vel_sun6_mod3, stack_flux_sun6_mod3 - (np.max(stack_flux_sun6_mod3) - 1), linestyle='--', label = "Solar $^{13}$CO")
plt.plot(stack_vel_sun6_mod4, stack_flux_sun6_mod4 - (np.max(stack_flux_sun6_mod4) - 1), linestyle='--', label = "3x Solar $^{13}$CO")
plt.xlabel("Velocity (km/s)")
plt.ylabel("Normalized Flux Intensity")
plt.axvline(x = 0, color= 'k', linestyle='--')
plt.legend()
